      ...
      <nav className="absolute top-0 left-0 w-full z-50 bg-transparent">
        <div className="max-w-[1400px] mx-auto px-6 h-24 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-[16px] font-bold text-[#FFFFFF] uppercase hover:opacity-80 transition-opacity" style={{ fontFamily: 'Balboa, sans-serif' }}>
              Login
            </a>
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-4 pt-20 flex flex-col items-center text-center">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-2 rounded-full mb-6">
            <span className="text-[#FFFFFF] text-[14px] lg:text-[18px] font-bold uppercase tracking-[3px]" style={{ fontFamily: 'Balboa, sans-serif' }}>
              1 MÊS GRÁTIS NA MENSALIDADE DO CONVIDADO
            </span>
          </div>
          
          {/* Título principal */}
          <h1 className="text-[56px] lg:text-[90px] font-black leading-[0.9] text-[#FFFFFF] mb-6 italic" style={{ fontFamily: 'Balboa, sans-serif' }}>
            O FLU SE VIVE JUNTO!
          </h1>
          
          {/* Subtítulo */}
          <p className="text-[20px] lg:text-[26px] font-medium text-[#FFFFFF] mb-12 max-w-2xl opacity-90" style={{ fontFamily: 'Balboa, sans-serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 w-full mb-12">
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-xl flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-white text-[14px] font-bold uppercase leading-tight" style={{ fontFamily: 'Balboa, sans-serif' }}>Mais prioridade na compra de ingressos</p>
            </div>
            {/* Benefício 2: Cifrão */}
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-xl flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-white text-[14px] font-bold uppercase leading-tight" style={{ fontFamily: 'Balboa, sans-serif' }}>Descontos em ingressos para convidados</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-xl flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-white text-[14px] font-bold uppercase leading-tight" style={{ fontFamily: 'Balboa, sans-serif' }}>Viva o jogo com quem faz parte da sua história</p>
            </div>
            {/* Benefício 4: Fogo */}
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-xl flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-white text-[14px] font-bold uppercase leading-tight" style={{ fontFamily: 'Balboa, sans-serif' }}>VAMOS TODOS JUNTOS RUMO À GLÓRIA</p>
            </div>
          </div>
          ...
          <a 
            ...
            style={{ fontFamily: 'Balboa, sans-serif' }}
          >
      ...
      <section id="planos" className="bg-[#F8F9FA] py-20">
        <div className="max-w-[1200px] mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-[32px] md:text-[40px] font-bold text-[#1C1C1C] uppercase italic" style={{ fontFamily: 'Balboa, sans-serif' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border-2 border-[#008C3A] flex flex-col">
              <h3 className="text-2xl font-bold mb-2" style={{ fontFamily: 'Balboa, sans-serif' }}>Arquiba 100%</h3>
              <div className="text-4xl font-black text-[#008C3A] mb-6" style={{ fontFamily: 'Balboa, sans-serif' }}>R$ 95<span className="text-sm text-gray-500">/mês</span></div>
              <ul className="space-y-4 mb-8 flex-grow" style={{ fontFamily: 'Balboa, sans-serif' }}>
              ...
              <button className="w-full bg-[#008C3A] text-white py-4 rounded-xl font-bold hover:bg-[#006b2c] transition-colors" style={{ fontFamily: 'Balboa, sans-serif' }}>ASSINAR AGORA</button>
            </div>

            {/* ARQUIBA 60% */}
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 flex flex-col">
              <h3 className="text-2xl font-bold mb-2" style={{ fontFamily: 'Balboa, sans-serif' }}>Arquiba 60%</h3>
              <div className="text-4xl font-black text-[#008C3A] mb-6" style={{ fontFamily: 'Balboa, sans-serif' }}>R$ 55<span className="text-sm text-gray-500">/mês</span></div>
              <ul className="space-y-4 mb-8 flex-grow" style={{ fontFamily: 'Balboa, sans-serif' }}>
            ...
            {/* GUERREIRO */}
            <div className="bg-white p-8 rounded-2xl shadow-md border border-gray-200 flex flex-col">
              <h3 className="text-2xl font-bold mb-2" style={{ fontFamily: 'Balboa, sans-serif' }}>Guerreiro</h3>
              <div className="text-4xl font-black text-[#008C3A] mb-6" style={{ fontFamily: 'Balboa, sans-serif' }}>R$ 25<span className="text-sm text-gray-500">/mês</span></div>
              <ul className="space-y-4 mb-8 flex-grow" style={{ fontFamily: 'Balboa, sans-serif' }}>
